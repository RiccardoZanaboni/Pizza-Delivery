...
public class PizzaDB extends Pizza {
    ...
    public static PreparedStatement putPizza(Connection con, String nome, String ingred, int prezzo){
        ...
        try{
            preparedStatement =con.prepareStatement("insert into PIZZERIA.Utenti values('"+nome+"','"+prezzo+"');");
    ...
    public static ResultSet getPizzaByName(Connection con, String name){
        ...
        try {
            ...
            rs=statement.executeQuery("select idUtenti from PIZZERIA.Utenti where idUtenti='"+name+"'");
            rs.next();
        }catch (Exception e){
