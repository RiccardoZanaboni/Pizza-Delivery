...
/**
 * Fornisce servizi riguardanti la "parte estetica" dell'interfaccia testuale.
 * */
public class TextColorServices {
	...
	private static String setBackgroundColorString(Color color){
		String background = "";
		if(color == Color.BLACK) background = "\u001B[40m";
		else if(color == RED) background = "\u001B[41m";
		else if(color == Color.GREEN) background = "\u001B[42m";
	...
	/** Disegna l'intestazione colorata del menu. */
